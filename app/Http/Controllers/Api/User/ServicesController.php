...
class ServicesController extends Controller
{
    ...
    public function OrganizationServicesBySlide()
    {
        try {
            ...
            return response()->json([
                'message' => 'An error occurred during OrganizationServicesBySlide',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
    ...
    public function ServicesBySlideStore(Request $request)
    {
        try {
            ...
            return response()->json([
                'message' => 'An error occurred during ServicesBySlideStore',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
    ...
    public function OrganizationServicesByTarget()
    {
        try {
            ...
            return response()->json([
                'message' => 'An error occurred during OrganizationServicesByTarget',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
    ...
    public function ServicesByTargetStore(Request $request)
    {
        try {
            ...
            return response()->json([
                'message' => 'An error occurred during ServicesByTargetStore',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
    ...
    public function OrganizationServicesFirst()
    {
        try {
            ...
            return response()->json([
                'message' => 'An error occurred during OrganizationServicesFirst',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
    ...
    public function OrganizationServicesSecond()
    {
        try {
            ...
            return response()->json([
                'message' => 'An error occurred during OrganizationServicesSecond',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
    ...
    public function OrganizationServicesBySatisfaction()
    {
        try {
           ...
           $benefitSatisfaction = BenefitSatisfaction::where('user_id', $user_id)->first();
            ...
            return response()->json([
                'message' => 'An error occurred during OrganizationServicesBySatisfaction',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
    ...
    public function ServicesBySatisfactionStore(Request $request)
    {
        try {
            ...
            return response()->json([
                'message' => 'An error occurred during ServicesBySatisfactionStore',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
