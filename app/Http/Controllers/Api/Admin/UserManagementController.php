...
class UserManagementController extends Controller
{
    ...
    public function UserManagement()
    {
        try {
            ...
            return response()->json([
                'message' => 'An error occurred during UserManagement',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
  ...
  return response()->json([
      ...
      'message' => 'تم تنفيذ طلبك'
            ...
            return response()->json([
                'message' => 'An error occurred during UserBulkAction',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
    ...
    public function UserEye($id)
    {
        try {
            ...
            return response()->json([
                'message' => 'An error occurred during UserEye',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
    ...
    public function AdminOrganizationBasic($id)
    {
        try {
            ...
            return response()->json([
                'message' => 'An error occurred during AdminOrganizationBasic',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
    ...
    public function AdminOrganizationAbout($id)
    {
        try {
            ...
            return response()->json([
                'message' => 'An error occurred during AdminOrganizationAbout',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
    ...
    public function AdminOrganizationFinancial($id)
    {
        try {
            ...
            return response()->json([
                'message' => 'An error occurred during AdminOrganizationFinancial',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
 ...
 return response()->json([
     ...
     'data' => [
         ...
         'benefitSatisfaction' => $benefitSatisfaction,
            ...
            return response()->json([
                'message' => 'An error occurred during AdminOrganizationServices',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
  ...
  $nationalities = Nationality::all();
        ...
        if($id){
            ...
            return response()->json([
                'message' => 'An error occurred during AdminOrganizationStaff',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
    ...
    public function AdminOrganizationVolunteers($id)
    {
        try {
            ...
            return response()->json([
                'message' => 'An error occurred during AdminOrganizationVolunteers',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
    ...
    public function SectoralChallenges($id)
    {
        ...
        try {
            ...
            return response()->json([
                'message' => 'An error occurred during SectoralChallenges',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
    ...
    public function InstituationalChallenges($id)
    {
        try {
            ...
            return response()->json([
                'message' => 'An error occurred during InstituationalChallenges',
                'error' => $e->getMessage(),
                'succeed' => false
            ], 500);
        }
