                                    ...
                                    <div class="col-md-12">
                                        <table class="table table-bordered text-center">
                                            ...
                                            <tr>
                                                <td>الاسم الأول</td>
                                                <td>
                                                    <input type="text" name="name_notCeo" class="form-control text-center" readonly value="{{ $staffRepresent ? $staffRepresent->name_notCeo : '' }}">
                                                </td>
                                                <td>
                                                    <input type="text" name="name_ceo" class="form-control text-center" readonly value="{{ $staffRepresent ? $staffRepresent->name_ceo : '' }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>اسم العائلة</td>
                                                <td>
                                                    <input type="text" name="family_notCeo" class="form-control text-center" readonly value="{{ $staffRepresent ? $staffRepresent->family_notCeo : '' }}">
                                                </td>
                                                <td>
                                                    <input type="text" name="family_ceo" class="form-control text-center" readonly value="{{ $staffRepresent ? $staffRepresent->family_ceo : '' }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>المنصب الوظيفي</td>
                                                <td>
                                                    <input type="text" name="position_notCeo" class="form-control text-center" readonly value="{{ $staffRepresent ? $staffRepresent->position_notCeo : '' }}">
                                                </td>
                                                <td>
                                                    <input type="text" name="position_ceo" class="form-control text-center" readonly value="{{ $staffRepresent ? $staffRepresent->position_ceo : '' }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>السنة المالية للالتحاق بالمنصب</td>
                                                <td>
                                                    <input type="text" name="year_notCeo" class="form-control text-center" readonly value="{{ $staffRepresent ? $staffRepresent->year_notCeo : '' }}">
                                                </td>
                                                <td>
                                                    <input type="text" name="year_ceo" class="form-control text-center" readonly value="{{ $staffRepresent ? $staffRepresent->year_ceo : '' }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>الجوال:</td>
                                                <td>
                                                    <input type="text" name="mobile_notCeo" class="form-control text-center" readonly value="{{ $staffRepresent ? $staffRepresent->mobile_notCeo : '' }}">
                                                </td>
                                                <td>
                                                    <input type="text" name="mobile_ceo" class="form-control text-center" readonly value="{{ $staffRepresent ? $staffRepresent->mobile_ceo : '' }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>البريد الإلكتروني:</td>
                                                <td>
                                                    <input type="text" name="email_notCeo" class="form-control text-center" readonly value="{{ $staffRepresent ? $staffRepresent->email_notCeo : '' }}">
                                                </td>
                                                <td>
                                                    <input type="text" name="email_ceo" class="form-control text-center" readonly value="{{ $staffRepresent ? $staffRepresent->email_ceo : '' }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>الارتباط:</td>
                                                <td>
                                                    <input type="text" name="link_notCeo" class="form-control text-center" readonly value="{{ $staffRepresent ? $staffRepresent->link_notCeo : '' }}">
                                                </td>
                                                <td>
                                                    <input type="text" name="link_ceo" class="form-control text-center" readonly value="{{ $staffRepresent ? $staffRepresent->link_ceo : '' }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>الفئة العمرية:</td>
                                                <td>
                                                    <input type="text" name="age_notCeo" class="form-control text-center" readonly value="{{ $staffRepresent ? $staffRepresent->age_notCeo : '' }}">
                                                </td>
                                                <td>
                                                    <input type="text" name="age_ceo" class="form-control text-center" readonly value="{{ $staffRepresent ? $staffRepresent->age_ceo : '' }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>المؤهل التعليمي الأعلى:</td>
                                                <td>
                                                    <input type="text" name="education_notCeo" class="form-control text-center" readonly value="{{ $staffRepresent ? $staffRepresent->education_notCeo : '' }}">
                                                </td>
                                                <td>
                                                    <input type="text" name="education_ceo" class="form-control text-center" readonly value="{{ $staffRepresent ? $staffRepresent->education_ceo : '' }}">
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                ...
                                <table class="table table-bordered text-center">
                                                            ...
                                                            @foreach($regions as $region)
                                                                ...
                                                                <td>
                                                                    <input type="number" name="number[{{ $nationality->id }}][{{ $gender->id }}][{{ $age->id }}][{{ $contract->id }}][{{ $region->id }}]"
                                                                           class="form-control contract-region-input" data-contract="{{ $contract->id }}" readonly data-region="{{ $region->id }}" oninput="calculateTotals()" value="{{ $existing->number ?? '' }}">
                                                                </td>
                                                            @endforeach
                                                        @endforeach
                                                        <td>
                                                            <input type="number" name="total_for_age[{{ $nationality->id }}][{{ $gender->id }}][{{ $age->id }}]" class="form-control total-for-age" readonly>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            @endforeach
                                    ...
                                    <tr>
                                        ...
                                        @foreach($contracts as $contract)
                                            @foreach($regions as $region)
                                                <td>
                                                    <input type="number" class="form-control total-for-contract-region" data-contract="{{ $contract->id }}" data-region="{{ $region->id }}" readonly>
                                                </td>
                                            @endforeach
                                        @endforeach
                                        <td>
                                            <input type="number" class="form-control total-for-all" readonly>
                                        </td>
                                    </tr>
                                    </tfoot>
                                </table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="number" name="staffDegree[{{ $degree->id }}][{{ $operation->id }}][engaged]"
                                                               class="form-control" value="{{ $existing->engaged ?? '' }}" readonly oninput="calculateRowTotal(this)">
                                                    </td>
                                                    <td>
                                                        <input type="number" name="staffDegree[{{ $degree->id }}][{{ $operation->id }}][not_engaged]"
                                                               class="form-control" value="{{ $existing->not_engaged ?? '' }}" readonly oninput="calculateRowTotal(this)">
                                                    </td>
                                                    <td>
                                                        <input type="number" name="staffDegree[{{ $degree->id }}][{{ $operation->id }}][certified]"
                                                               class="form-control" value="{{ $existing->certified ?? '' }}" readonly oninput="calculateRowTotal(this)">
                                                    </td>
                                                    <td>
                                                        <input type="number" name="staffDegree[{{ $degree->id }}][{{ $operation->id }}][not_certified]"
                                                               class="form-control" value="{{ $existing->not_certified ?? '' }}" readonly oninput="calculateRowTotal(this)">
                                                    </td>
                                                    <td>
                                                        <input type="number" name="staffDegree[{{ $degree->id }}][{{ $operation->id }}][office_work]"
                                                               class="form-control" value="{{ $existing->office_work ?? '' }}" readonly oninput="calculateRowTotal(this)">
                                                    </td>
                                                    <td>
                                                        <input type="number" name="staffDegree[{{ $degree->id }}][{{ $operation->id }}][field_work]"
                                                               class="form-control" value="{{ $existing->field_work ?? '' }}" readonly oninput="calculateRowTotal(this)">
                                                    </td>
                                                    <td>
                                                        <input type="number" name="staffDegree[{{ $degree->id }}][{{ $operation->id }}][mixed_work]"
                                                               class="form-control" value="{{ $existing->mixed_work ?? '' }}" readonly oninput="calculateRowTotal(this)">
                                                    </td>
                                                    <td>
                                                        <input type="number" name="staffDegree[{{ $degree->id }}][{{ $operation->id }}][total]"
                                                               class="form-control"  value="{{ $existing->total ?? '' }}" readonly>
                                                    </td>
