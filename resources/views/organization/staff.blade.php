...
@section('main')
                                    ...
                                    <div class="col-md-12">
                                        <table class="table table-bordered text-center">
                                            ...
                                            <tr>
                                                <td>الاسم الأول</td>
                                                <td>
                                                    <input type="text" name="name_notCeo" class="form-control text-center" value="{{ $staffRepresent ? $staffRepresent->name_notCeo : '' }}">
                                                </td>
                                                <td>
                                                    <input type="text" name="name_ceo" class="form-control text-center" value="{{ $staffRepresent ? $staffRepresent->name_ceo : '' }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>اسم العائلة</td>
                                                <td>
                                                    <input type="text" name="family_notCeo" class="form-control text-center" value="{{ $staffRepresent ? $staffRepresent->family_notCeo : '' }}">
                                                </td>
                                                <td>
                                                    <input type="text" name="family_ceo" class="form-control text-center" value="{{ $staffRepresent ? $staffRepresent->family_ceo : '' }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>المنصب الوظيفي</td>
                                                <td>
                                                    <input type="text" name="position_notCeo" class="form-control text-center" value="{{ $staffRepresent ? $staffRepresent->position_notCeo : '' }}">
                                                </td>
                                                <td>
                                                    <input type="text" name="position_ceo" class="form-control text-center" value="{{ $staffRepresent ? $staffRepresent->position_ceo : '' }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>السنة المالية للالتحاق بالمنصب</td>
                                                <td>
                                                    <input type="text" name="year_notCeo" class="form-control text-center" value="{{ $staffRepresent ? $staffRepresent->year_notCeo : '' }}">
                                                </td>
                                                <td>
                                                    <input type="text" name="year_ceo" class="form-control text-center" value="{{ $staffRepresent ? $staffRepresent->year_ceo : '' }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>الجوال:</td>
                                                <td>
                                                    <input type="text" name="mobile_notCeo" class="form-control text-center" value="{{ $staffRepresent ? $staffRepresent->mobile_notCeo : '' }}">
                                                </td>
                                                <td>
                                                    <input type="text" name="mobile_ceo" class="form-control text-center" value="{{ $staffRepresent ? $staffRepresent->mobile_ceo : '' }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>البريد الإلكتروني:</td>
                                                <td>
                                                    <input type="text" name="email_notCeo" class="form-control text-center" value="{{ $staffRepresent ? $staffRepresent->email_notCeo : '' }}">
                                                </td>
                                                <td>
                                                    <input type="text" name="email_ceo" class="form-control text-center" value="{{ $staffRepresent ? $staffRepresent->email_ceo : '' }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>الارتباط:</td>
                                                <td>
                                                    <input type="text" name="link_notCeo" class="form-control text-center" value="{{ $staffRepresent ? $staffRepresent->link_notCeo : '' }}">
                                                </td>
                                                <td>
                                                    <input type="text" name="link_ceo" class="form-control text-center" value="{{ $staffRepresent ? $staffRepresent->link_ceo : '' }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>الفئة العمرية:</td>
                                                <td>
                                                    <input type="text" name="age_notCeo" class="form-control text-center" value="{{ $staffRepresent ? $staffRepresent->age_notCeo : '' }}">
                                                </td>
                                                <td>
                                                    <input type="text" name="age_ceo" class="form-control text-center" value="{{ $staffRepresent ? $staffRepresent->age_ceo : '' }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>المؤهل التعليمي الأعلى:</td>
                                                <td>
                                                    <input type="text" name="education_notCeo" class="form-control text-center" value="{{ $staffRepresent ? $staffRepresent->education_notCeo : '' }}">
                                                </td>
                                                <td>
                                                    <input type="text" name="education_ceo" class="form-control text-center" value="{{ $staffRepresent ? $staffRepresent->education_ceo : '' }}">
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                ...
                                <table class="table table-bordered text-center">
                                                    ...
                                                    @foreach($contracts as $contract)
                                                        @foreach($regions as $region)
                                                            @php
                                                                ...
                                                                $staffInformation = App\Models\StaffInformation::where('user_id', $user_id)->get();
                                                            ...
                                                            @endphp
                                                            <td>
                                                                <input type="text" name="number[{{ $nationality->id }}][{{ $gender->id }}][{{ $age->id }}][{{ $contract->id }}][{{ $region->id }}]"
                                                                       class="form-control text-center contract-region-input" data-contract="{{ $contract->id }}" data-region="{{ $region->id }}" inputmode="numeric" pattern="[0-9]*" oninput="calculateTotals()" value="{{ $existing->number ?? '' }}">
                                                            </td>
                                                        @endforeach
                                                    @endforeach
                                                    <td>
                                                        <input type="text" name="total_for_age[{{ $nationality->id }}][{{ $gender->id }}][{{ $age->id }}]" class="form-control text-center total-for-age" readonly>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @endforeach
                                    ...
                                    <tr>
                                        ...
                                        @foreach($contracts as $contract)
                                            @foreach($regions as $region)
                                                <td>
                                                    <input type="text" class="form-control text-center total-for-contract-region" data-contract="{{ $contract->id }}" data-region="{{ $region->id }}" readonly>
                                                </td>
                                            @endforeach
                                        @endforeach
                                        <td>
                                    ...
                                    @foreach($degrees as $degree)
                                        @foreach($operations as $index => $operation)
                                            @php
                                                ...
                                                $user_id = Auth::user()->id;
                                                $staffDegree = App\Models\StaffDegree::where('user_id', $user_id)->get();
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" name="staffDegree[{{ $degree->id }}][{{ $operation->id }}][engaged]"
                                                           class="form-control text-center" value="{{ $existing->engaged ?? '' }}" oninput="calculateRowTotal(this)">
                                                </td>
                                                <td>
                                                    <input type="number" name="staffDegree[{{ $degree->id }}][{{ $operation->id }}][not_engaged]"
                                                           class="form-control text-center" value="{{ $existing->not_engaged ?? '' }}" oninput="calculateRowTotal(this)">
                                                </td>
                                                <td>
                                                    <input type="number" name="staffDegree[{{ $degree->id }}][{{ $operation->id }}][certified]"
                                                           class="form-control text-center" value="{{ $existing->certified ?? '' }}" oninput="calculateRowTotal(this)">
                                                </td>
                                                <td>
                                                    <input type="number" name="staffDegree[{{ $degree->id }}][{{ $operation->id }}][not_certified]"
                                                           class="form-control text-center" value="{{ $existing->not_certified ?? '' }}" oninput="calculateRowTotal(this)">
                                                </td>
                                                <td>
                                                    <input type="number" name="staffDegree[{{ $degree->id }}][{{ $operation->id }}][office_work]"
                                                           class="form-control text-center" value="{{ $existing->office_work ?? '' }}" oninput="calculateRowTotal(this)">
                                                </td>
                                                <td>
                                                    <input type="number" name="staffDegree[{{ $degree->id }}][{{ $operation->id }}][field_work]"
                                                           class="form-control text-center" value="{{ $existing->field_work ?? '' }}" oninput="calculateRowTotal(this)">
                                                </td>
                                                <td>
                                                    <input type="number" name="staffDegree[{{ $degree->id }}][{{ $operation->id }}][mixed_work]"
                                                           class="form-control text-center" value="{{ $existing->mixed_work ?? '' }}" oninput="calculateRowTotal(this)">
                                                </td>
                                                <td>
                            ...
                            <div id="staffSection3" style="display: none">
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control text-center" name="benefit_male" oninput="calculateTotal('benefit')"
                                                   value="{{ $staffOthers ? $staffOthers->benefit_male : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="benefit_female" oninput="calculateTotal('benefit')"
                                                   value="{{ $staffOthers ? $staffOthers->benefit_female : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="benefit_total" readonly
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control text-center" name="fees_male" oninput="calculateTotal('fees')"
                                                   value="{{ $staffOthers ? $staffOthers->fees_male : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="fees_female" oninput="calculateTotal('fees')"
                                                   value="{{ $staffOthers ? $staffOthers->fees_female : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="fees_total" readonly
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control text-center" name="free_male" oninput="calculateTotal('free')"
                                                   value="{{ $staffOthers ? $staffOthers->free_male : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="free_female" oninput="calculateTotal('free')"
                                                   value="{{ $staffOthers ? $staffOthers->free_female : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="free_total" readonly
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control text-center" name="expenses_male" oninput="calculateTotal('expenses')"
                                                   value="{{ $staffOthers ? $staffOthers->expenses_male : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="expenses_female" oninput="calculateTotal('expenses')"
                                                   value="{{ $staffOthers ? $staffOthers->expenses_female : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="expenses_total" readonly
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control text-center" name="value_male" oninput="calculateTotal('value')"
                                                   value="{{ $staffOthers ? $staffOthers->value_male : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="value_female" oninput="calculateTotal('value')"
                                                   value="{{ $staffOthers ? $staffOthers->value_female : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="value_total" readonly
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control text-center" name="trainees_male" oninput="calculateTotal('trainees')"
                                                   value="{{ $staffOthers ? $staffOthers->trainees_male : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="trainees_female" oninput="calculateTotal('trainees')"
                                                   value="{{ $staffOthers ? $staffOthers->trainees_female : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="trainees_total" readonly
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control text-center" name="graduates_male" oninput="calculateTotal('graduates')"
                                                   value="{{ $staffOthers ? $staffOthers->graduates_male : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="graduates_female" oninput="calculateTotal('graduates')"
                                                   value="{{ $staffOthers ? $staffOthers->graduates_female : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="graduates_total" readonly
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control text-center" name="fullTime_male" oninput="calculateTotal('fullTime')"
                                                   value="{{ $staffOthers ? $staffOthers->fullTime_male : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="fullTime_female" oninput="calculateTotal('fullTime')"
                                                   value="{{ $staffOthers ? $staffOthers->fullTime_female : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="fullTime_total" readonly
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control text-center" name="partTime_male" oninput="calculateTotal('partTime')"
                                                   value="{{ $staffOthers ? $staffOthers->partTime_male : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="partTime_female" oninput="calculateTotal('partTime')"
                                                   value="{{ $staffOthers ? $staffOthers->partTime_female : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="partTime_total" readonly
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control text-center" name="consulting_male" oninput="calculateTotal('consulting')"
                                                   value="{{ $staffOthers ? $staffOthers->consulting_male : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="consulting_female" oninput="calculateTotal('consulting')"
                                                   value="{{ $staffOthers ? $staffOthers->consulting_female : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="consulting_total" readonly
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control text-center" name="management_male" oninput="calculateTotal('management')"
                                                   value="{{ $staffOthers ? $staffOthers->management_male : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="management_female" oninput="calculateTotal('management')"
                                                   value="{{ $staffOthers ? $staffOthers->management_female : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="management_total" readonly
                                ...
                                <table class="table table-bordered text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control text-center" name="workers_male" oninput="calculateTotal('workers')"
                                                   value="{{ $staffOthers ? $staffOthers->workers_male : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="workers_female" oninput="calculateTotal('workers')"
                                                   value="{{ $staffOthers ? $staffOthers->workers_female : '' }}">
                                        </td>
                                        <td>
                                            <input type="number" class="form-control text-center" name="workers_total" readonly
    ...
    <script>
        ...
        window.onload = function() {
            calculateTotal('benefit');
            calculateTotal('fees');
            calculateTotal('free');
            calculateTotal('expenses');
            calculateTotal('value');
            calculateTotal('trainees');
            calculateTotal('graduates');

            calculateTotal('fullTime');
            calculateTotal('partTime');
            calculateTotal('consulting');
            calculateTotal('management');
