...
@section('title')
    nusuk | نٌسكـ (عرض بيانات الواقع المالي)
@endsection
@section('content')
        ...
        <div class="content">
            ...
            <div class="container" dir="rtl">
                ...
                <div id="financialSection1">
                    <div class="row" >
                        <div class="col-md-8" style="border-left: 1px solid #444444">
                            <h5>إجمالي الإيرادات السنوية (بالريال) </h5>
                        </div>
                        <div class="col-md-4">
                            <h5>إجمالي النفقات والمصاريف السنوية (بالريال) </h5>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="public_sector" required readonly
                        ...
                        <div class="col-md-4" style="border-left: 1px solid #444444">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="personalization_assignment" required readonly
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="services_sector" required readonly
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="nonprofit_sector" required readonly
                        ...
                        <div class="col-md-4" style="border-left: 1px solid #444444">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="commercial_monetary" required readonly
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="others_sector" required readonly
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="private_sector" required readonly
                        ...
                        <div class="col-md-4" style="border-left: 1px solid #444444">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="social" required readonly
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="general_expenses" required readonly
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="donations" required readonly
                        ...
                        <div class="col-md-4" style="border-left: 1px solid #444444">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="endowment_wallet" required readonly
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="marketing_expenses" required readonly
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="self_employment" required readonly
                        ...
                        <div class="col-md-4" style="border-left: 1px solid #444444">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="loans_received" required readonly
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="directed_expenses" required readonly
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="borrowing_paying" required readonly
                ...
                <div id="financialSection2" style="display:none;">
                    <div class="row">
                        <div class="col-md-12">
                            <h5>إجمالي الإنفاق الاجتماعي الموجه لقطاع خدمة ضيوف الرحمن (بالريال) – بحسب مجالات العمل</h5>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="suspense_polarization" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="special_needs" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="public_places" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="translation" required readonly
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="awareness_education" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="attracting_volunteers" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="project_development" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="smart_applications" required readonly
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="reception" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="health_care" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="village_development" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="interaction_facilities" required readonly
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="farewell_distribution" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="security_safety" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="media_contribution" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="leadership_innovation" required readonly
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="transport" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="cash_assistance" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="advocacy_guidance" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="studies_research" required readonly
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="reservations_facilities" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="eye_assistance" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="child_care" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="qualification_training" required readonly
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="basic_services" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="feeding_watering" required readonly
                ...
                <div id="financialSection3" style="display: none">
                    <div class="row">
                        <div class="co-md-12">
                            <h5>إجمالي الإنفاق الاجتماعي الموجه لقطاع خدمة ضيوف الرحمن (بالريال) – بحسب إطار تنفيذ العمل</h5>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="seasonal_services" required readonly
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="establishing_initiatives" required readonly
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="organizing_events" required readonly
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h5>إجمالي الإنفاق الاجتماعي الموجه لقطاع خدمة ضيوف الرحمن (بالريال) – بحسب الجهة المنتفعة استراتيجيا من الأثر المتحقق</h5>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="ministry_hajj" required readonly
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="ministry_municipal_affairs" required readonly
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="ministry_transportation" required readonly
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="ministry_hr" required readonly
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="ministry_tourism" required readonly
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="Development_authority" required readonly
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="ministry_interior" required readonly
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="ministry_media" required readonly
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="general_presidency" required readonly
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="ministry_external" required readonly
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="ministry_health" required readonly
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="royal_commission" required readonly
                ...
                <div id="financialSection4" style="display: none">
                    <div class="row">
                        <div class="col-md-12">
                            <h5>إجمالي الممتلكات (بالريال):</h5>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="fixed_assets" required readonly
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="investment_wallet" required readonly
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="book_endowment_wallet" required readonly
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h5>إجمالي المحفظة الاستثمارية (بالريال):</h5>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-md-5">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="association_fund" required readonly
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="stocks_securities" required readonly
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="other_investments" required readonly
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="social_investments" required readonly
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="investment_portfolio_management" required readonly
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h5>إجمالي الأجور السنوية المدفوعة للعاملين (بالريال السعودي)، شاملا الرواتب الأساسية، وجميع البدلات (مثل بدل السكن والمواصلات)، وجميع المزايا الوظيفية (مثل التأمينات الاجتماعية والصحية)، والحوافز (أي المكافآت):</h5>
                        </div>
                    </div>
                    <br>
                    <br>
                    <div class="row">
                        <div class="col-md-5">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="paid_CEO" required readonly
                        ...
                        <div class="col-md-5">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control text-center" name="paid_employee" required readonly
